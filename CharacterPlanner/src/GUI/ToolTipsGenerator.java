   ...
   public void generateNotChangingTips() {
    ...
    public void generateChangingTips(Character character) {
       ...
       /*********Perks*********/
        ...
        perksTipsMap.put("Better Criticals", "<html>Better Criticals <br> (+) +20% ranged crit power <br> (+) +25% melee crit power<br> Requirements: <br>");
        ...
        perksTipsMap.put("Bonus Ranged Damage", "<html>Bonus Ranged Damage <br> (+) +2 damage with ranged weapons<br> Requirements: <br>");
        ...
        perksTipsMap.put("Bonus Rate of Attack", "<html>Bonus Rate of Attack <br> (+) -1 AP required to attack (ranged or melee) <br> Requirements: <br>");
        ...
        perksTipsMap.put("Dodger(1)", "<html>Dodger(1)<br>(+) -5% to final hit chance (works only with melee/unarmed/throwing weapons in both hands)<br>(+) +5 to Movement Speed <br> Requirements: <br>");
        perksTipsMap.put("Dodger(2)", "<html>Dodger(2)<br>(+) -5% to final hit chance (works only with melee/unarmed/throwing weapons in both hands)<br>(+) +5 to Movement Speed <br> Requirements: <br>");
        ...
        perksTipsMap.put("Field Medic", "<html>Field Medic<br> (+) +20-40 HP healed with First Aid <br> (+) +5% to chance to score critical success when using First Aid<br> (+) +5 to damage when attacking living organisms <br> (+) You can see other players' First Aid and Doctor Cooldowns in on-cursor awareness<br> (+) When you use First Aid/Doctor on other players your cooldown is applied to them<br> <font color=\"red\"> (-) You can not use First Aid/Doctor on people who are on cooldown</font><br> Requirements: <br>");
        perksTipsMap.put("Gain Agility", "<html>Gain Agility<br> (+) +2 Agility<br> Requirements: <br>");
        perksTipsMap.put("Gain Charisma", "<html>Gain Charisma<br> (+) +2 Charisma<br> Requirements: <br>");
        perksTipsMap.put("Gain Endurance", "<html>Gain Endurance<br> (+) +2 Endurance<br> Requirements: <br>");
        perksTipsMap.put("Gain Intelligence", "<html>Gain Intelligence<br> (+) +2 Intelligence<br> Requirements: <br>");
        perksTipsMap.put("Gain Luck", "<html>Gain Luck<br> (+) +2 Luck<br> Requirements: <br>");
        perksTipsMap.put("Gain Perception", "<html>Gain Perception<br> (+) +2 Perception    <br> Requirements: <br>");
        perksTipsMap.put("Gain Strength", "<html>Gain Strength<br> (+) +2 Strength<br> Requirements: <br>");
        perksTipsMap.put("Ghost", "<html>Ghost<br> (+) +30 bonus to Sneak when within 5 hexes from a wall<br> Requirements: <br>");
        perksTipsMap.put("Heave Ho!", "<html>Heave Ho!<br> (+) +2 Strength for throw Range calculation <br> (+) +6 to throw range <br> (+) +5 Movement Speed <br> Requirements: <br>");
        ...
        perksTipsMap.put("Iron Limbs", "<html>Iron Limbs<br> (+) EN–3 roll to avoid leg cripple <br> (+) EN–3 roll to avoid arm cripple<br> (+) ST–4 roll to avoid weapon drop<br> Requirements: <br>");
        ...
        perksTipsMap.put("Medic", "<html>Medic<br> (+) Healing First Aid and Doctor cooldowns reduced by 50% <br> (+) 15-30 more Hit Points from First Aid <br> (+) allows removal of KO on others with doctor skill<br> Requirements: <br>");
        ...
        perksTipsMap.put("Pyromaniac", "<html>Pyromaniac<br> (+) +30% fire-based damage<br> Requirements: <br>");
        ...
        perksTipsMap.put("Sharpshooter", "<html>Sharpshooter<br> (+) +6 Field of View <br> (+) +8% to your chance to hit <br> (+) -50% to your target's armor's (both head and body) critical chance modifiers for aimed attacks only<br> Requirements: <br>");
        ...
        /*********Masteries*********/
        masteriesTipsMap.put("Tank", "<html>Tank <br> (+) +20 max Hit Points <br> (+) +5 to all Damage Resistances <br> (+) +2 to all Damage Threshold<br> Requirements: <br>");
       ...
       implantsTipsMap.put("Right Knee", "<html>Right Knee <br> (+) You are quick at stand up from being knocked down(It takes you only 1/2 of normal time to get back on your feet <br> Requirements: <br>");
       ...
       implantsTipsMap.put("Left Hand", "<html>Left Hand <br> (+) Temporarily disabled, working on a new bonus<br> Requirements: <br>");
       ...
       implantsTipsMap.put("Cerebral Modem", "<html>Cerebral Modem <br> (+) +10% Electric DR <br> Requirements: <br>");
        ...
        supportsTipsMap.put("Mr. Fixit", "<html>Mr. Fixit<br> (+) Repairing items is easier (+100% in Repairing)<br> Requirements: <br>");
        supportsTipsMap.put("Nightkin", "<html>Nightkin<br> (+) +50 max Hit Points <br> (+) +5 Normal DR <br> (+) +3 Normal DT <br> (+) while in sneak, all successful rear attacks have Silent Death effect <br> (+) radiation immunity <br> (+) you can wear Mutants Armors<br> Requirements: <br>");
        supportsTipsMap.put("Mutant", "<html>Mutant<br> (+) +100 max Hit Points <br> (+) +10 Healing rate <br> (+) +10 Normal DR <br> (+) +3 Normal DT <br> (+) radiation immunity <br> (+) you can wear Mutants Armors<br> Requirements: <br>");
        ...
        supportsTipsMap.put("Straight Shooter", "<html>Straight Shooter<br> (+) +2 bonus flat damage<br> Requirements: <br>");
